...
## <a name="listofactions">ааааааааааа</a>
...
- для проверки кода приложения ментором, вам нужно будет добавить его в коллаборанты
...
## FAQ
[English for kids. Intro](https://www.youtube.com/watch?v=XFt03V5amPw)
